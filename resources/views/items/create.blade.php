...
@section('content')
	...
	{!! Form::open(['method' => 'POST', 'route' => ['items.store'], 'files'=> true ]) !!}
	
	<div class="card">
        <div class="card-header bg-dark text-white">
            @lang('global.app_create') @lang('global.items.title')
        </div>
        ...
        <div class="card-body">
           ...
           <div class="row">
                <div class="col-sm-4 offset-sm-4 form-group">
	                ...
	                {!! Form::file('item_image',  old('item_image'), ['class' => 'form-control', ]) !!}
	                <p class="help-block"></p>
